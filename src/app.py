...
class CanIdentify:
    def __init__(self, master):
        self.master = master
        self.master.title("Can Sequence Identify")  # Título inicial da janela
...
#-----------------------------------------------------------------------#
    ...
    def display_current_plot(self):
        ...
        self.plot_title.config(text=f"{self.nome_arquivo} | Gráfico {self.current_plot_index + 1} de {len(self.best_results)}")
